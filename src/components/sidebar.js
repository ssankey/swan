...
import { faHome, faBriefcase, faUser, faGift, faUserPlus, faFlask, faBox, faTimes } from '@fortawesome/free-solid-svg-icons';
...
const Sidebar = ({ isOpen, toggleSidebar }) => {
    ...
    return (
        <div className={`fixed z-40 top-0 left-0 h-screen p-4 bg-white shadow-lg transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'
            }`} >
            <div>
